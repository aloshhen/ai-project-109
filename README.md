...
- Next.js (для SSR, SEO и удобной маршрутизации)  
- TypeScript (строгая типизация)  
- Tailwind CSS + Framer Motion (анимации и стилизация)  
- Web3.js / Ethers.js (работа с крипто-кошельками)  
- Telegram WebApp SDK (интеграция с TMA)  
- NFT Storage (хранение NFT метаданных)  
- Vercel (деплой)
